  ...
  const steps = [
    {
      ...
      description:
        "I start our collaboration by collecting client requirements, listing and compiling them. This helps us build the process from scratch to deliver results aligned with your goals.",
      icon: ClipboardList,
    ...
    },
    {
      ...
      description:
        "After gathering requirements, we devise a strategic path and select resources.I offer clients a roadmap, laying the groundwork for a successful project.",
      icon: Map,
    ...
    },
    {
      ...
      description:
        "In the design and development phase,I turn strategic ideas into digital products that are visually appealing, technically robust, focusing on user experience and functionality.",
      icon: Palette,
    ...
    },
    {
      ...
      description:
        "In this phase,I rigorously test and validate to ensure all elements work correctly and meet standards, delivering the desired user experience. Our team tests each aspect for reliability.",
      icon: TestTube,
    ...
    },
    {
      ...
      title: "Deployment",
      description:
        "Once the product meets standards, I deploy it, releasing product or updates on servers. This ensures our products are delivered seamlessly and efficiently.",
      icon: Rocket,
    ...
    },
    {
      ...
      description:
        "In the final stage, I maintain systems to ensure smooth operation, security, and reliability. Optimization keeps performance high and client satisfaction focused on operational excellence.",
      icon: Wrench,
